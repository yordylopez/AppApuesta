...
public class ProfileFragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        try {
            date = formater.parse(currentUser.getFecha_nacimiento());
            this.fecha_nacimiento.setText(formater.format(date));
        } catch (ParseException e) {
            this.fecha_nacimiento.setText(currentUser.getFecha_nacimiento());
            e.printStackTrace();
    ...
    private void setTxtSaldo(JugadorBanca jugadorBanca){
        this.dinero_disponible.setText(Float.toString(jugadorBanca.getSaldoDisponible()));
        this.dinero_jugado.setText(Float.toString(jugadorBanca.getSaldoPendiente()));
    }
