...
public class UserRepository<U extends User> extends ModelRepository<U> {
    ...
    public U createUser(String email, String password)     {
     ...
     /**
     * Creates a {@link com.yordy.ecoresi.remoting.adapters.RestContract} representing the user type's custom
     * routes. Used to extend an {@link com.yordy.ecoresi.remoting.adapters.Adapter} to support user. Calls
     * super {@link ModelRepository} createContract first.
     *
     * @return A {@link com.yordy.ecoresi.remoting.adapters.RestContract} for this model type.
     */
                ...
                new Adapter.JsonObjectCallback() {
                    ...
                    public void onSuccess(JSONObject response) {
                        ...
                        U user = userJson != null
                                ...
                                : null;
                        Log.e("userJson", user.toMap().toString());
